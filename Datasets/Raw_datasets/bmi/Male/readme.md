# Mean body mass index (BMI) in men - Data package

This data package contains the data that powers the chart ["Mean body mass index (BMI) in men"](https://ourworldindata.org/grapher/mean-body-mass-index-bmi-in-adult-males?tab=table&time=2000..2015&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website. It was downloaded on November 15, 2024.
...
## Mean BMI in men
Mean Body Mass Index (BMI) in adult men (aged 18+ years).
...
#### Full citation
NCD RisC (2017) – processed by Our World in Data. “Mean BMI in men” [dataset]. NCD RisC (2017) [original data].
